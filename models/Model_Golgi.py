...
def model_golgi(df_golgi):
    ...
    temp_train_path = "data/splits/golgi_temp_train.csv"
    temp_val_path = "data/splits/golgi_temp_val.csv"
    temp_test_path = "data/splits/golgi_temp_test.csv"
