...
def model_reticulum(df_reticulum):
    ...
    temp_train_path = "data/splits/reticulum_temp_train.csv"
    temp_val_path = "data/splits/reticulum_temp_val.csv"
    temp_test_path = "data/splits/reticulum_temp_test.csv"
    ...
    model_dir = "models/model_reticulum"
