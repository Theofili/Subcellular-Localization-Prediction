...
def model_peroxisome(df_peroxisome):
    ...
    temp_train_path = "data/splits/peroxisome_temp_train.csv"
    temp_val_path = "data/splits/peroxisome_temp_val.csv"
    temp_test_path = "data/splits/peroxisome_temp_test.csv"
    ...
    model_dir = "models/model_peroxisome"
...
import pandas as pd
df = pd.read_csv('data/model_data/model_peroxisome_data.csv')
