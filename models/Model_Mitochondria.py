...
def model_mitochondria(df_mitochondria):
    ...
    temp_train_path = "data/splits/mitochondria_temp_train.csv"
    temp_val_path = "data/splits/mitochondria_temp_val.csv"
    temp_test_path = "data/splits/mitochondria_temp_test.csv"
    ...
    model_dir = "models/model_mitochondria"
...
import pandas as pd
df = pd.read_csv('data/model_data/model_mitochondria_data.csv')
