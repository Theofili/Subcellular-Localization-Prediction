...
def model_nuclear(df_nuclear):
    ...
    temp_train_path = "data/splits/nuclear_temp_train.csv"
    temp_val_path = "data/splits/nuclear_temp_val.csv"
    temp_test_path = "data/splits/nuclear_temp_test.csv"
    ...
    model_dir = "models/model_nuclear"
